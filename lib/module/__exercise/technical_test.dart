...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      String? output;
      output = "${input.toIso8601String().substring(0, 10)}";
      // --- End of Answer ---
    ...
    () {
      ...
      bool? output;
      output = (input["isActive"] == "true") ? true : null;
      // --- End of Answer ---
      return output == true;
    },
    // Exercise 148
    () {
      ...
      bool? output;
      output = input["hasPermission"] == "false" ? true : null;
    ...
    () {
      ...
      bool? output;
      output = (input["isAvailable"] == "1") ? true : null;
      // --- End of Answer ---
      return output == true;
    },
    // Exercise 150
    () {
      ...
      bool? output;
      output = input["isEnabled"] == "0" ? true : null;
      // --- End of Answer ---
      return output == true;
    },
    // Exercise 151
    ...
    () {
      ...
      List<bool>? output;
      output = input.split(',').map((value) => value == 'true').toList();
      // --- End of Answer ---
      return output.length == 4 &&
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
       List<int> input = [1, 2, 3, 4, 5];
      Map<String, int> output;
      output = {for (var number in input) 'number': number};
      // --- End of Answer ---
    ...
    () {
      ...
      output = {
        for (var item in input) item: item,
      };
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, int>? output;
      output =
          Map.fromIterable(input.split(','), key: (e) => e, value: (e) => 1);
    ...
    () {
      ...
      List<int> keys = input.split(",").map(int.parse).toList();
      Map<int, String>? output = {for (var key in keys) key: "value"};
      return output.length == 3;
      // --- End of Answer ---
    ...
    () {
      ...
      List<int>? output;
      output = input.split(',').map(int.parse).toList();
      output = output.map((number) => number % 2 == 0 ? 0 : number).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
       List<String> input = ["apple", "banana", "cherry"];
      Map<String, int>? output = {for (var fruit in input) fruit: fruit.length};
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<int> input = [1, 2, 3, 4, 5];
      Map<int, int>? output = {for (var num in input) num: num * num};
    ...
    () {
      ...
      List<String> input = ["apple", "banana", "cherry"];
      List<Map<String, int>>? output =
          input.map((fruit) => {"length": fruit.length}).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<String>? output;
      output = input.split(',').map((e) => e.toString()).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      String input = "true,false,true,false,true";
      List<bool>? output;
      output = input.split(',').map((e) => e.toLowerCase() == 'true').toList();
      // --- End of Answer ---
    ...
    () {
      ...
      output = input
          .split(',')
          .map((boolString) => boolString.toLowerCase() == 'true')
          .toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<bool>? output;
      output =
          input.split(',').map((str) => str.toLowerCase() == 'true').toList();
      // --- End of Answer ---
    ...
    () {
      ...
      output = Map.fromIterable(
        input.split(','),
        key: (item) => item.split(':')[0],
        value: (item) => double.parse(item.split(':')[1]),
      );
      // --- End of Answer ---
  ...
  input.split(','),
  key: (item) => item.split(':')[0],
  value: (item) => item.split(':')[1].toLowerCase() == 'true',
);
      // --- End of Answer ---
  ...
  value: (item) => DateTime.parse(item.split(':')[1]),
    ...
    */
    ...
    () {
      ...
      bool? output = input[input.length - 1] == 't';
   ...
   String output = text.substring(0, 10);
    ...
    () {
      ...
      String output = text.substring(4,15);
      return (output == " is awesome");
    },
    ...
    int output = text.split('').where((char) => char == 'x').length;
      return output == 0;
    },
    ...
    int output = text.split('').where((char) => char.toLowerCase() == 'a').length;
      return output == 2;
    },
